...
class AerogardenConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Aerogarden integration."""
    ...
    def async_get_options_flow(config_entry: ConfigEntry) -> OptionsFlow:
        ...
        return AerogardenOptionsFlowHandler(config_entry) 

class AerogardenOptionsFlowHandler(OptionsFlow):
    """Handle an Aerogarden options flow."""
